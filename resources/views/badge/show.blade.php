...
<div class="container">
    <svg class="animated" width="170px" height="158px" viewBox="0 0 170 158" version="1.1"
         xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs>
            <filter x="-9.5%" y="-8.9%" width="119.1%" height="120.6%" filterUnits="objectBoundingBox" id="filter-1">
...
<script type="text/javascript">
    ...
    var makeTada = function makeTada() {
