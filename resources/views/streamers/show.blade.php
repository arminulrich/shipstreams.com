...
@section('meta')
    ...
    <!-- Facebook OG Image -->
    <meta property="og:image" content="https://placid.app/u/ktnsy?picture-0=$PIC${!! urlencode($streamer->main_channel()->profile_image_url()) !!}&text-0={!! urlencode($streamer->og_image_text) !!}"/>
    <meta property="og:image:height" content="600"/>
    <meta property="og:image:width" content="1200"/>

    <!-- Twitter Card Image -->
    <meta property="twitter:image" content="https://placid.app/u/ktnsy?picture-0=$PIC${!! urlencode($streamer->main_channel()->profile_image_url()) !!}&text-0={!! urlencode($streamer->og_image_text) !!}"/>
    ...
    <div class="detail">
        ...
        <div class="container">
            ...
            <div class="detail__stream">
                ...
                @if($streamer->is_online  || $streamer->twitch_username)
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4 ">
                        ...
                        @if($streamer->youtube_channel_id)
                            ...
                            <a class="font-weight-bold" href="https://youtube.com/channel/{{$streamer->youtube_channel_id}}"
                               target="_blank">
                ...
                <div class="detail__teaser-illustration">
                    <svg width="383px" height="153px" viewBox="0 0 383 153" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="Desktop-HD-Copy-2" transform="translate(-166.000000, -1490.000000)" fill="#5596FF" fill-rule="nonzero">
